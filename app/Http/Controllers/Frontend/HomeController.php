...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        SEOTools::setCanonical(url()->current()); // Đặt URL chuẩn
    ...
    TwitterCard::setSite('@AkayTruyen');
        ...
        'pinnedComments',
        'regularComments','totalStory','totalChapter','totalViews','totalRating','topDonors', 'months', 'selectedMonth', 'selectedYear'));
    }
    ...
    private function cleanWordText($text)
{
    $search = [
        "\xC2\xAB", "\xC2\xBB", // « »
        "\xE2\x80\x98", "\xE2\x80\x99", // ‘ ’ (nháy đơn)
        "\xE2\x80\x9C", "\xE2\x80\x9D", // “ ” (nháy kép)
        "\xE2\x80\x93", "\xE2\x80\x94", // – — (gạch ngang)
