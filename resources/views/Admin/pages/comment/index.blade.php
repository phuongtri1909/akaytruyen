                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @can('xoa_nguoi_dung')
                                <form action="{{ route('delete.comments', $item->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa bình luận này?');">
                                    @csrf
                                    @method('DELETE')
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                form.closest('tr').fadeOut(300, function() { $(this).remove(); }); // Xóa hàng chứa bình luận
            } else {
