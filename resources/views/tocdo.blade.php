...
if (isset($_SERVER['QUERY_STRING']) && preg_match('/.css/', $_SERVER['QUERY_STRING']) && $dwcSetting['minify-css-files'] == true) {
    cssFileCreate($_SERVER['QUERY_STRING']);
}

if (isset($_SERVER['QUERY_STRING']) && preg_match('/.js/', $_SERVER['QUERY_STRING']) && $dwcSetting['minify-js-files'] == true) {
