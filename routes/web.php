...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::get('/admin/settings/tinymce-usage', [SettingsController::class, 'getTinyMCEUsage'])->name('settings.getTinyMCEUsage');
    Route::post('/admin/settings/tinymce-usage', [SettingsController::class, 'trackTinyMCEUsage'])->name('settings.trackTinyMCEUsage');
    Route::get('/admin/settings/tinymce-usage', [SettingsController::class, 'getTinyMCEUsage'])->name('settings.getTinyMCEUsage');
