...
.chapter-list li {
                                            ...
                                            @foreach ($chaptersNew as $chapterNew)
                                                <li style="list-style: none">
                                                    <a href="{{ route('chapter', ['slugStory' => $story->slug, 'slugChapter' => $chapterNew->slug]) }}"
                                                        class="text-decoration-none text-dark hover-title"><span class="new-badge">{{ $chapterNew->name }}</span></a>
                                                </li>
                            ...
                            <div class="card-search py-2">
                                <div class="search-wrapper">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="search-chapter" data-story-slug="{{ $story->slug }}" placeholder="Chương, Tên chương, Nội dung ...">
    ...
    <input class="form-check-input" type="checkbox" id="orderToggle" {{ request()->input('old_first') ? 'checked' : '' }}>
...
@php
    ...
    $reversedChapters = $isOldFirst ? $chapters->sortBy('chapter') : $chapters->sortByDesc('chapter');
@endphp
                            ...
                            <div class="row" id="chapters-container">
                                ...
                                <div class="d-block d-md-none">
                                    ...
                                    @foreach ($reversedChapters as $chapter)
                                            <li class="mt-2">
                                                <a href="{{ route('chapter', ['slugStory' => $story->slug, 'slugChapter' => $chapter->slug]) }}" class="text-muted">
                                                    <span class="date">
