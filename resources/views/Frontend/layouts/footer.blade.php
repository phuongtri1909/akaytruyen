                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center justify-content-center" style="height: 150px;">
                                    <a target="_blank" href="https://www.facebook.com/groups/1134210028188278/"
                                        ...
                                        <img src="{{ asset('assets/frontend/images/Facebook_Logo.png') }}" alt="logo_fb" 
                        ...
                        <div class="donation-info">
                            <ul class="list-unstyled ">
                                <li class="mb-2 d-flex flex-column align-items-start">
                                    ...
                                    <img src="{{ asset('assets/frontend/images/techcombank.jpg') }}" alt="banking-techcombank" class="" height="250">
                                </li>
...
@media (max-width: 768px) {
    .marquee p {
        font-size: 14px;
        animation-duration: 10s; /* Chạy nhanh hơn trên mobile */
    }
}
    ...
    <div class="bg-dark">
        <div class="container py-3">
            <span class="copyright text-white">
                ...
                <a href="//www.dmca.com/Protection/Status.aspx?ID=3da5a11e-fc82-4343-b6a0-8515713d3c33" title="DMCA.com Protection Status" class="dmca-badge"> <img src ="https://images.dmca.com/Badges/dmca_protected_sml_120m.png?ID=3da5a11e-fc82-4343-b6a0-8515713d3c33"  alt="DMCA.com Protection Status" /></a>  <script src="https://images.dmca.com/Badges/DMCABadgeHelper.min.js"> </script>
            </span>
        </div>
